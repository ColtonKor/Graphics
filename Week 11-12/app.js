...
function updateAndRender() {
    ...
    var rotationX = new Matrix4().makeRotationX(runUP);
    var rotationY = new Matrix4().makeRotationY(runLR);
    var overall = rotationX.multiply(rotationY);
    var tempVec4 = overall.multiplyVector(new Vector4(lightDirection.x, lightDirection.y, lightDirection.z, 0));
    lightDirection = new Vector3(tempVec4.x, tempVec4.y, tempVec4.z);
