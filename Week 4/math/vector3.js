// Add your own Vector3.js or download the solution file and place it in this directory.
var Vector3 = function(x, y, z) {
  ...
  Vector3.prototype = {
    ...
    divide: function(divisor){
        this.x = this.x/divisor.x;
        this.y = this.y/divisor.y;
        this.z = this.z/divisor.z;
        return this;
    },
